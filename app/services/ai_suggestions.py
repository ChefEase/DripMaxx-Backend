...
async def generate_suggestions(
  ...
  sys_prompt = (
    ...
    "- Use simple, everyday words that most people understand.\n"
    "- Write at about a 6th grade reading level.\n"
    "- Keep each description to one short sentence.\n"
    "- Avoid fashion jargon and complex words like silhouette, cohesion, palette, proportions, elevate, refine, intentional, premium, focal, structured, and uniform.\n"
  ...
  if not _is_valid_detection(detection):
    repair_prompt = (
      ...
      "- use simple, everyday words and one short sentence for each description.\n"
      "- avoid fashion jargon and complex words.\n"
      "- Output only JSON.\n\n"
      f"RAW:\n{raw}"
    )
